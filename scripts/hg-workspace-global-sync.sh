...
: "${CLAUDE_JSON_PATH:=$WORKSPACE_HOME/.claude.json}"
: "${CLAUDE_HOME_DOC_PATH:=$WORKSPACE_HOME/.claude/CLAUDE.md}"
: "${CLAUDE_SKILLS_DIR:=$WORKSPACE_HOME/.claude/skills}"
: "${CLAUDE_COMMANDS_DIR:=$WORKSPACE_HOME/.claude/commands}"
: "${AGENTS_SKILLS_DIR:=$WORKSPACE_HOME/.agents/skills}"
: "${CODEX_SKILLS_DIR:=$WORKSPACE_HOME/.codex/skills}"
: "${CODEX_CONFIG_PATH:=$WORKSPACE_HOME/.codex/config.toml}"
: "${GEMINI_HOME_DOC_PATH:=$WORKSPACE_HOME/.gemini/GEMINI.md}"
: "${GEMINI_PROJECTS_PATH:=$WORKSPACE_HOME/.gemini/projects.json}"
: "${GEMINI_SETTINGS_PATH:=$WORKSPACE_HOME/.gemini/settings.json}"
: "${CLAUDE_PROJECT_KEY:=$WORKSPACE_ROOT}"
