# hg-mcp — Detailed Reference

> This file contains reference tables, code examples, and detailed architecture docs.
> For build commands and key patterns, see [CLAUDE.md](./CLAUDE.md).
