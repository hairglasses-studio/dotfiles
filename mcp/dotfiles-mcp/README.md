...
| Desktop Control | Hyprland, semantic AT-SPI targeting with refs/actions/multi-match queries, session-local accessibility and D-Bus control, screenshot/OCR, clipboard, notifications, shaders, audio, and Wayland input workflows |
