...
func dotfilesWorkflowCatalog() []dotfilesWorkflowCatalogEntry {
	return []dotfilesWorkflowCatalogEntry{
		...
		},
		{
			...
			KeyTools:     []string{"dotfiles_rice_check", "system_health_check", "dotfiles_desktop_status", "notify_history_entries", "hypr_list_windows", "hypr_get_monitors", "dotfiles_reload_service", "dotfiles_cascade_reload"},
		},
		{
			...
			KeyTools:     []string{"dotfiles_desktop_status", "dotfiles_rice_check", "dotfiles_workspace_scene", "desktop_capabilities", "desktop_snapshot", "desktop_list_windows", "desktop_target_windows", "desktop_find", "desktop_find_all", "desktop_focus_window", "desktop_focus", "desktop_read_value", "desktop_set_text", "desktop_set_value", "desktop_form_fields", "desktop_fill_form", "desktop_act", "desktop_wait_for_element", "kitty_status", "kitty_list_tabs", "kitty_list_windows", "kitty_focus_tab", "kitty_focus_window", "kitty_launch", "kitty_get_text", "kitty_send_key", "kitty_send_text", "hypr_list_windows", "hypr_get_monitors", "hypr_monitor_preset_list", "hypr_layout_list", "session_list", "session_connect", "session_wait_ready", "session_status", "session_list_apps", "session_accessibility_tree", "session_find_ui_element", "session_find_ui_elements", "session_focus_element", "session_read_value", "session_set_text", "session_set_value", "session_form_fields", "session_fill_form", "session_click_element", "session_invoke_action", "session_type_text", "session_dbus_call", "session_read_log", "desktop_project_open", "desktop_screenshot_ocr", "desktop_find_text", "input_type_text", "desktop_click_text", "dotfiles_reload_service", "dotfiles_cascade_reload"},
		},
		{
			Name:         "config_repair",
			Title:        "Config Repair",
...
func dotfilesSkillCatalog() []dotfilesSkillCatalogEntry {
	...
	skillDescriptions := map[string]string{
		...
		"dotfiles_ui":              "Desktop UI, rice, shader, Ironbar, Hyprland, and screenshot workflow for the dotfiles repo.",
