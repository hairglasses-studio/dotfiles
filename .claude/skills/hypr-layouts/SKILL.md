---
name: hypr-layouts
description: 'Hyphenated compatibility alias for the hypr_layouts workflow.'
allowed-tools:
  - Bash
  - Read
...
<!-- GENERATED BY hg-skill-surface-sync.sh FROM .agents/skills/hypr_layouts/SKILL.md; DO NOT EDIT -->

Compatibility alias for the canonical `hypr_layouts` skill.
