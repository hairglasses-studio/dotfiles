---
name: color-pipeline
description: 'Hyphenated compatibility alias for the color_pipeline workflow.'
allowed-tools:
  - Bash
  - Read
  - Write
...
<!-- GENERATED BY hg-skill-surface-sync.sh FROM .agents/skills/color_pipeline/SKILL.md; DO NOT EDIT -->

Compatibility alias for the canonical `color_pipeline` skill.
