---
name: content-writer
description: 'Hyphenated compatibility alias for the content_writer workflow.'
allowed-tools:
  - Bash
  - Read
  - Write
...
<!-- GENERATED BY hg-skill-surface-sync.sh FROM .agents/skills/content_writer/SKILL.md; DO NOT EDIT -->

Compatibility alias for the canonical `content_writer` skill.
