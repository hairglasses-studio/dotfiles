---
name: canary-monitor
description: 'Hyphenated compatibility alias for the canary_monitor workflow.'
allowed-tools:
  - Bash
  - Read
  - Grep
...
<!-- GENERATED BY hg-skill-surface-sync.sh FROM .agents/skills/canary_monitor/SKILL.md; DO NOT EDIT -->

Compatibility alias for the canonical `canary_monitor` skill.
