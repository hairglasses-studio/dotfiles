---
name: gh-portfolio-audit
description: 'Hyphenated compatibility alias for the gh_portfolio_audit workflow.'
allowed-tools:
  - Bash
  - Read
  - Write
...
Compatibility alias for the canonical `gh_portfolio_audit` skill.
