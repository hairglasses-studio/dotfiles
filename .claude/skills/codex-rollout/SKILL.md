---
name: codex-rollout
description: 'Hyphenated compatibility alias for the codex_rollout workflow.'
allowed-tools:
  - Bash
  - Read
  - Write
...
<!-- GENERATED BY hg-skill-surface-sync.sh FROM .agents/skills/codex_rollout/SKILL.md; DO NOT EDIT -->

Compatibility alias for the canonical `codex_rollout` skill.
