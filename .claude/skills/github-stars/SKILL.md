---
name: github-stars
description: 'Hyphenated compatibility alias for the github_stars workflow.'
allowed-tools:
  - Bash
  - Read
  - Write
...
<!-- GENERATED BY hg-skill-surface-sync.sh FROM .agents/skills/github_stars/SKILL.md; DO NOT EDIT -->

Compatibility alias for the canonical `github_stars` skill.
