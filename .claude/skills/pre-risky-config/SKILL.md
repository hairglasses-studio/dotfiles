---
name: pre-risky-config
description: 'Hyphenated compatibility alias for the pre_risky_config workflow.'
allowed-tools:
  - Read
  - Edit
  - Write
...
Compatibility alias for the canonical `pre_risky_config` skill.
