---
name: kitty-control
description: 'Hyphenated compatibility alias for the kitty_control workflow.'
allowed-tools:
  - Bash
  - Read
...
<!-- GENERATED BY hg-skill-surface-sync.sh FROM .agents/skills/kitty_control/SKILL.md; DO NOT EDIT -->

Compatibility alias for the canonical `kitty_control` skill.
