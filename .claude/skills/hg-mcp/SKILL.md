---
name: hg-mcp
description: 'Hyphenated compatibility alias for the hg_mcp workflow.'
allowed-tools:
  - Bash
  - Read
  - Grep
...
<!-- GENERATED BY hg-skill-surface-sync.sh FROM .agents/skills/hg_mcp/SKILL.md; DO NOT EDIT -->

Compatibility alias for the canonical `hg_mcp` skill.
