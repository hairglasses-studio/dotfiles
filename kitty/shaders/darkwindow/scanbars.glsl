void windowShader(inout vec4 color)
{
    ...
    float grain = fract(sin(uv.x * 12.9898 + uv.y * 78.233 + x_Time * 0.2) * 43758.5453123);
    ...
    float scratches = smoothstep(0.0, 1.0, sin(uv.y * 100.0 + x_Time * 5.0) * 0.5 + 0.5);
