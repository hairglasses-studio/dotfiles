...
void windowShader(inout vec4 color) {
    ...
    vec3 col;
    col.r = x_Texture(vec2(uv.x-ABBERATION_FACTOR*amount / x_WindowSize.x, uv.y) ).r;
    col.g = x_Texture(uv ).g;
    col.b = x_Texture(vec2(uv.x+ABBERATION_FACTOR*amount / x_WindowSize.x, uv.y) ).b;
