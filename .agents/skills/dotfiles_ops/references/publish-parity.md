...
3. If a mirror-managed MCP module changed, run `bash ./scripts/hg-mcp-mirror-parity.sh --check` and then `bash ./scripts/sync-standalone-mcp-repos.sh --dry-run` before any parity mutation.
