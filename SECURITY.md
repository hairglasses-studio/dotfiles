...
If you discover a security vulnerability in dotfiles, please report it responsibly.
...
This policy applies to the dotfiles this project. Security issues in dependencies should be reported to the respective upstream projects.
...
dotfiles includes several security-oriented packages:
