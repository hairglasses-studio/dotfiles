...
- MCP packaging and parity: `mcp/`, `mcp/mirror-parity.json`, `docs/MCP-MIRROR-PARITY.md`, `scripts/hg-mcp-mirror-parity.sh`, `.mcp.json`, `scripts/hg-codex-mcp-sync.sh`, `scripts/hg-codex-audit.sh`
