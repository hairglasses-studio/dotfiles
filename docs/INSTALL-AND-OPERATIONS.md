...
- runtime logs land under `~/.local/state/juhradial/` for the daemon and overlay plus `~/.local/state/hyprdynamicmonitors/` for monitor-profile churn so journal noise can stay narrow
