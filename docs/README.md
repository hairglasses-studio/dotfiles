...
This directory holds the searchable, repo-local documents that sit below the root README.
...
Read `ARCHITECTURE-PROVENANCE.md` first when you need to decide whether a change belongs in installer/bootstrap code, workstation runtime config, or the automation and MCP surface.
